...
favoriteMovie.quote = "With great power comes great responsibility"
...
console.log (greeting + ' I am ' + " my favorite movie is " + favoriteMovie.name + " I rate the movie a " + favoriteMovie.rating + " and the genre is " + favoriteMovie.genre + " and one of its popular quotes is " +favoriteMovie.quote)
